...
define("BASE_SO_HOST", "(DESCRIPTION = (ADDRESS = (PROTOCOL = TCP)(HOST = 192.168.110.6)(PORT = 1521))(CONNECT_DATA=(SID=ORCL)))");
define("BASE_SO_USER", "TRM");
define("BASE_SO_PASSWORD", "TRM");
