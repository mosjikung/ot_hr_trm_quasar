<template>
  <div class="q-pa-md">
    ...
    <!--     <div class="row justify-center">
                <div class="col-md-2">
                  <q-input outlined v-model="text" label="Insert Dept Code" />
                </div>
                <div class="col-md-1"></div>
                <div class="col-md-2">
                  <q-input outlined v-model="text" label="Insert Dept Name" />
                </div>
                <div class="col-md-1"></div>
                <div class="col-md-2">
                  <q-input
